...
define("_AM_SPARTNER_FILE_NAME_DSC", "نامی که برای شناسایی فایل بکار می رود.");
define("_AM_SPARTNER_FILE_STATUS", "فایل قابل دیدن باشد؟");
define("_AM_SPARTNER_FILE_STATUS_DSC", "اگر نه را انتخواب کنید, این فایل در بخش کاربر قابل دیدن نیست.");
...
define("_AM_SPARTNER_OFFER_CREATE_INFO", "فرم زیر را برای ایجاد یک پیشنهاد پر کنید.");
