...
define("_AM_SPARTNER_ACTIVE_EDITING_INFO", "Puede editar este patrocinador activo. Las modificaciones tendrán efecto inmediatamente en su perfil.");
...
Ésta es una lista de los patrocinadores activos que son mostrados a los usuarios. Puedes editar o eliminar cada patrocinador haciendo clic en el botón relacionado en la columna <b>Acción</b>.");
...
define("_AM_SPARTNER_FILE_EDITING_DSC", "Puede editar este archivo. Las modificaciones estarán visibles para los usuarios inmediatamente.");
...
define("_AM_SPARTNER_INACTIVE_EDITING_INFO", "Puede editar este patrocinador inactivo. Las modificaciones serán salvadas para este patrocinador. Sin embargo, si desea mostrar este patrocinador a los usuarios, necesitará establecer el campo de <b>Estado</b> a 'Activo'.");
...
define("_AM_SPARTNER_REJECTED_EDITING_INFO", "Puede editar este patrocinador rechazado. Las modificaciones serán salvadas para este patrocinador. Sin embargo, si desea mostrar al mismo a los usuarios necesitará establecer el campo <b>Estado</b> como 'Activo'.");
...
define("_AM_SPARTNER_SUBMITTED_INFO", "Este patrocinador ha solicitado ser incluído en tu sitio web. Puede editar su información como guste; puedes también hacer las modificaciones que desee. Una vez aprobada la solicitud será mostrado el patrocinador a los visitantes de la web.");
...
define("_AM_SPARTNER_CATEGORY_EDIT", "Editar categoría");
...
define("_AM_SPARTNER_CATEGORY_EDIT_INFO", "Puede editar esta categoría. Las modificaciones tendrán efecto inmediato para los usuarios.");
