...
define("_MD_SPARTNER_NOPARTNERSELECTED", "Sie haben keinen g&uuml;ltigen Partner ausgew&auml;hlt.");
define("_MD_SPARTNER_NOTIFY", "Bei Gew&auml;rung Benachrichtigung senden");
define("_MD_SPARTNER_READMORE", "Lesen Sie mehr...");
define("_MD_SPARTNER_SUBMIT_ERROR", "Ein Fehler trat auf w&auml;hrend der Partnerschaftsantrag eingereicht wurde.");
...
define("_MD_SPARTNER_DELETE", "L&ouml;schen");
...
define("_MD_SPARTNER_ERROR1", "Sie haben den Antrag nicht korrekt ausgef&uuml;llt. Bitte gehen Sie zur&uuml;ck, und nehmen Sie die notwendigen Ver&auml;nderungen vor.");
...
define("_MD_SPARTNER_GOBACK", "<a href='javascript:history.back(1)'>Zur&uuml;ck</a>");
define("_MD_SPARTNER_NEWPARTNER", "%s Partner Nachfragen");
define("_MD_SPARTNER_SENDMAIL", "Anfrageemail wurde an den Administrator abgeschickt.<br /><a href='index.php'>Zur&uuml;ck zum Index</a>");
...
define("_MD_SPARTNER_INTRO_JOIN", "M&ouml;chten Sie mit %s Partner werden? Bitte f&uuml;llen Sie das nachfolgende Formular aus, und wir melden uns schnellst m&ouml;glichst bei Ihnen.");
...
define("_MD_SPARTNER_BACKTOINDEX", "Zur&uuml;ck zu Partner Index");
