...
define("_AM_SPARTNER_CATEGORY_CREATE_INFO", "Fülle die folgenden Felder der Reihe nach aus um eine neue Kategorie anzulegen. Diese wird automatisch auf der Userseite angezeigt.");
